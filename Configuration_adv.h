...
//#define LCD_BACKLIGHT_TIMEOUT 30 // (s) Timeout before turning off the backlight
  ...
  #define PROBE_OFFSET_WIZARD       // Add a Probe Z Offset calibration option to the LCD menu JTB
...
#define BABYSTEPPING //JTB
  ...
  #define BABYSTEP_ZPROBE_OFFSET          // Combine M851 Z and Babystepping JTB
