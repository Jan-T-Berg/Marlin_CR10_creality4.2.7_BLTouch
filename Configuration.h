...
#define STRING_CONFIG_H_AUTHOR "(JTB)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "JTB-Drucker"
...
#define Z_MIN_ENDSTOP_INVERTING true // Set to true to invert the logic of the endstop. JTB wenn schließer bei NPN = true, PNP = false
 ...
 */
//#define MULTIPLE_PROBING 2 //JTB Kann man noch anpassen
...
#define AUTO_BED_LEVELING_BILINEAR //JTB
 ...
 */
#define RESTORE_LEVELING_AFTER_G28 //JTB
...
#define Z_SAFE_HOMING
  ...
  #define Z_SAFE_HOMING_X_POINT 150  // X point for Z homing JTB
