...
#define STRING_CONFIG_H_AUTHOR "(JTB, Ender-3)" // Who made the changes.
 ...
 */
//#define Z_MIN_PROBE_USES_Z_MIN_ENDSTOP_PIN //JTB

// Force the use of the probe for Z-axis homing
#define USE_PROBE_FOR_Z_HOMING //JTB
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -40, -10, 0 } //JTB
...
#define ENABLE_LEVELING_AFTER_G28 //JTB

/**
 * Auto-leveling needs preheating
 */
#define PREHEAT_BEFORE_LEVELING //JTB
